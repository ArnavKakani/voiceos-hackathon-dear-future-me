...
// Generate speech-like cadence for the visual speaking state only. This
// renderer never invokes a browser/system voice.
...
function animate() {
    ...
    if (state.pulsate) {
        if (state.pulsateMode === 'audio-reactive') {
            ...
            // SPEAKING: visual cadence only; this renderer never emits audio.
